...
```{r}
a_file <- here::here("fits", "b13_01.qs")
b13.1 <- qread(a_file)
# b13.1 <- brm(
#   data = dataFrogs,
#   family = binomial,
...
```{r}
a_file <- here::here("fits", "b13_02.qs")
b13.2 <- qread(a_file)
# b13.2 <- brm(
#   data = dataFrogs,
#   family = binomial,
...
```{r}
a_file <- here::here("fits", "b13_03.qs")
b13.3 <- qread(a_file)
# b13.3 <- brm(
#   data = sim$data,
#   family = binomial,
...
```{r}
a_file <- here::here("fits", "b13_04.qs")
b13.4 <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "b13_05.qs")
b13.5 <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "b13_06.qs")
b13.6 <- qread(a_file)
...
We can do a posterior fit for chimp #2. Remember this chimp was an outlier as
it was always pulling the left lever no matter what.
