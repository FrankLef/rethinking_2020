...
We also simulate $\beta$ with `sinmstudy` which is more versatile and easier
to code (personal opinion), e.g. no need to convert with `inv_logit_scaled` and
no need to run the model with `prior_draws()`
