...
samples$newdata <- dataAdmit %>%
  ...
  # expand(gid, 
  #        admit = seq(from = min(dataAdmit$admit) to = , n =10), 
  #        applications = seq_range(dataAdmit$applications, n = 10))
# str(samples$newdata)
# str(dataAdmit)

# str(samples$data)
# class(samples$newdata)
# predict(b12.1, newdata = samples$newdata)
