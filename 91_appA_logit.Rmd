...
# Appendix A - `logit()` distribution

McElreath and Kurz create `logistic()`, `logit()`, etc. Actually
...
In McElreath's [GitHub page](https://github.com/rmcelreath/rethinking/blob/a309712d904d1db7af1e08a76c521ab994006fd5/R/distributions.r), there are 2 functions, `logistic()` and `inv_logit()` who are identical
...
`m11.1` by McElreath with `rethinking` and b11.1 by Kurz with `brms`.
...
the logistic function as programmed by McElreath and Kurz is
